...
import com.zyf.springboot.Demo17ApplicationTests;
...
public class UserServiceTest extends Demo17ApplicationTests {
    ...
    public void update() {
        ...
        if (lastVo != null) {
            lastVo.setAge(99);
            boolean effect = userService.updateVo(lastVo);
    ...
    public void deleteById() {
        UserVo lastVo = getLastVo();
        if (lastVo != null) {
            int effect = userService.deleteByUserId(lastVo.getId());
