...
public class RoleResourceServiceTest extends Demo21ApplicationTests {
    ...
    @Test
    public void get() {
        RoleResource roleResource = roleResourceService.selectById(1);
        Assert.notNull(roleResource, "get 查询为空");
    }

    @Test
    public void list() {
        List<RoleResource> roleResources = roleResourceService.selectList(new EntityWrapper<>(new RoleResource()));
    ...
    public void add() {
        ...
        boolean effect = roleResourceService.insert(roleResource);
    ...
    public void update() {
        ...
        if (lastVo != null) {
            ...
            boolean effect = roleResourceService.updateById(lastVo);
    ...
    public void deleteById() {
        RoleResource lastVo = getLast();
        if (lastVo != null) {
            boolean effect = roleResourceService.deleteById(lastVo.getId());
