...
public class Demo27ApplicationTests {
    ...
    protected <T> ResponseEntity<T> getJson(String uri, Class<T> clazz, Object... uriVariables) {
        return this.restTemplateWithCookies.exchange(
                getHost(uri),
                HttpMethod.GET,
                null,
                clazz,
    ...
    protected <T> ResponseEntity<T> postForm(String uri, MultiValueMap<String, Object> args, Class<T> clazz) {
        ...
        return this.restTemplateWithCookies.postForEntity(getHost(uri), requestEntity, clazz);
    }
    ...
    protected <T> Map<String, Object> toMap(T t) {
        return this.orikaMapper.convertMap(t);
    }
