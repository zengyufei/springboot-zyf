...
public class AddCreateIdName implements ObjectSerializer {
    ...
    public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (fifoCache.containsKey(object)) {
            ...
            serializer.getWriter().writeFieldValue(',', "createName", StringUtils.isBlank(value) ? "" : value);
        } else {
            ...
            if (user != null) {
                ...
                fifoCache.put(object, value, RandomUtil.randomInt(60 * 1000));
                serializer.getWriter().writeFieldValue(',', "createName", StringUtils.isBlank(value) ? "" : value);
            }
        }
