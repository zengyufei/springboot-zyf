...
public class MenuUtils {
    ...
    public static List<Menu> toTree(List<Operation> list) {
        List<Menu> rootMenu = new ArrayList<>();
        try {//查询所有菜单
            //根节点
            for (Operation operation : list) {
                Menu nav = new Menu(operation);
     ...
     */
    private static List<Menu> getChild(Integer id, List<Operation> allMenu) {
        //子菜单
        List<Menu> childList = new ArrayList<>();
        for (Operation operation : allMenu) {
    ...
    public static class Menu {
        ...
        public Menu(Operation operation) {
            ...
            this.parentId = operation.getParentId();
            this.name = operation.getOperationName();
            this.url = operation.getUrl();
            this.sort = operation.getSort();
        }
