...
public class UserRoleServiceTest extends Demo20ApplicationTests {
    ...
    @Test
    public void list() {
        List<UserRole> userRoles = userRoleService.selectList(new EntityWrapper<>(new UserRole()));
    ...
    public void add() {
        ...
        boolean effect = userRoleService.insert(userRole);
    ...
    public void update() {
        ...
        if (lastVo != null) {
            lastVo.setUserId(2);
            boolean effect = userRoleService.updateById(lastVo);
    ...
    public void deleteById() {
        UserRole lastVo = getLast();
        if (lastVo != null) {
            boolean effect = userRoleService.deleteById(lastVo.getId());
